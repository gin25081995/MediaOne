...
public class QuanLiDiaPhim extends JPanel {
  JTextField txtMa, txtTen, txtNhaPhatHanh, txtTheLoai, txtNgayNhap, txtGia;
  JButton btnTimKiem, btnThem, btnLamMoi, btnSua, btnXoa, btnThoat;
  
  /**
   * Tab 3- Quan li dia phim.
   */
  public QuanLiDiaPhim() {
    String [] tenCot3 = {"Mã", "Tên", "Nhà phát hành", "Ngày nhập", "Thể loại", "Giá" };
    this.setLayout(new BorderLayout());
    this.add(new MyTable(tenCot3), BorderLayout.CENTER);
    ...
    panel4.add(l4 = new JLabel("Thể loại")); panel4.add(txtTheLoai = new JTextField(20));
