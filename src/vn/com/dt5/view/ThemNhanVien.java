...
public class ThemNhanVien extends JFrame {
  JComboBox<Month> cbThang;
  
  public ThemNhanVien() {
    this.setTitle("Giao Diện Thêm Nhân Viên");
    setDiplay();
   add(createGui());
  }
    ...
    JLabel lblThongTin = new JLabel("Mời bạn nhập thông tin: ");
    ...
    btnThem.setIcon(new ImageIcon("images/add24px.png"));
    ...
    btnThem.setPreferredSize(btnLamMoi.getPreferredSize());
