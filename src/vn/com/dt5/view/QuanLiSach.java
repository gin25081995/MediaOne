...
public class QuanLiSach extends JPanel{
	 JTextField txtMa, txtTen, txtNhaXuatBan, txtTheLoai, txtNgayNhap, txtGia;
...
private void CreateGUI() {
	...
	String[] tenCot = {"Mã", "Tên", "Nhà xuất bản", "Thể loại", "Ngày nhập", "Giá"};
	this.add(new MyTable(tenCot), BorderLayout.CENTER);
	...
	panel3.add(l3 = new JLabel("Nhà xuất bản")); panel3.add(txtNhaXuatBan = new JTextField(20));
